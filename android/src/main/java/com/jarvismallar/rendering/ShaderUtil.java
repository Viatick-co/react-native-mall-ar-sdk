 ...
 */
package com.jarvismallar.rendering;
...
public class ShaderUtil {
  ...
  public static void checkGLError(String tag, String label) {
    ...
    if (lastError != GLES20.GL_NO_ERROR) {
      throw new RuntimeException(label + ": glError 0x" + String.format("%x", lastError));
    }
  }

  // for AR Engine compatibility
  public static void checkGlError(String tag, String label) {
    checkGLError(tag, label);
  }
