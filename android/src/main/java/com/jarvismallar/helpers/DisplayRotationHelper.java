 ...
 */
package com.jarvismallar.helpers;
...
public final class DisplayRotationHelper implements DisplayListener {
   ...
   * function should be called explicitly before each call to onFrame. This
   * function will also clear the 'pending update' (viewportChanged) flag.
   *
   * @param session the Api object to update if display geometry changed.
   */
  public void updateSessionIfNeeded(Api session) {
    if (viewportChanged) {
